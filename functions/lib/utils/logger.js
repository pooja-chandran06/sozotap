...
exports.safeLogger = {
    info: (message, data) => {
        if (data) {
            functionsLogger.info(message, (0, redaction_1.sanitizeLogObject)(data));
        }
        else {
    ...
    warn: (message, data) => {
        if (data) {
            functionsLogger.warn(message, (0, redaction_1.sanitizeLogObject)(data));
        }
        else {
    ...
    error: (message, error, data) => {
        const sanitizedData = data ? (0, redaction_1.sanitizeLogObject)(data) : {};
